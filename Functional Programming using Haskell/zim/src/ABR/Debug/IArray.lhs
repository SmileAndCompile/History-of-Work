% IArray.#ext
% This file was produced from IArray.lit
...
Module \highlighttt{ABR.Debug.IArray} is used to help
debug programs that use immutable arrays.
...
Reviewed 2009-10-27: Changed to {\tt ABR.\emph{Debug}.\emph{IArray}}.
...
\noindent A \highlighttt{array'} is a replacement for {\tt
array} that displays a different error message so you can
pin down which array indexing operation is out of range.
...
\noindent A \highlighttt{accumArray'} is a replacement for
{\tt accumArray} that displays a different error message
so you can pin down which array indexing operation is out
of range.
