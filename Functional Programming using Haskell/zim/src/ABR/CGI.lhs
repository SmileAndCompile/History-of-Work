...
Reviewed 2013-11-25.\\
Reviewed 2012-11-05: Removed dependence on {\tt ABR.Data.BSTree}.\\
Reviewed 2009-11-27: Yes there is a standard library for XHTML
generation, but it is not so compellingly better than this
that I'm ready to deprecate this. Am updating so that the
generated code is XHTML-Transitional.
...
\noindent Identify the kind of html being generated.
\highlighttt{docType} is printed by 
which is printed by \highlighttt{printDocType}.
...
The {\tt html} element needs to have certain attributes
to meet standards. \highlighttt{htmlT} applies the attributes to go with the
transitional doctype above.
...
\noindent For debugging forms: 
\highlighttt{dumpFormData}~$\mathit{tree}$ outputs the
form inputs in a nicely encoded XHTML fragment.
