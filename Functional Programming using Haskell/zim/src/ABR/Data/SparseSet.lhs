...
\module{(Deprecated) Data.SparseSet} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Module \highlighttt{ABR.Data.SparseSet} implements a set type where the
...
Reviewed 2009-10-27: Changed to {\tt ABR.\emph{Data}.SparseSet}.
