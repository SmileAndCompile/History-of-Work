...
Reviewed 2012-10-31: Made compliant with new GHC. Deprecated anyway.\\
...
leftBST (Node _ _ l _ _)     = leftBST l
rightBST Empty                = Nothing
rightBST (Node k v _ Empty _) = Just (k, v)
rightBST (Node _ _ _ r _)     = rightBST r
\end{code}
